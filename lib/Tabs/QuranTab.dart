        ...
        Row(
          children: [
            Expanded(child: Text(
                ...
                AppLocalizations.of(context)!.sura_name,style: Theme.of(context).textTheme.titleMedium)),
            Container(
              height: 40,
              width: 2,
            ...
            Expanded(child: Text(
              textAlign: TextAlign.center,
                AppLocalizations.of(context)!.verses_number,style: Theme.of(context).textTheme.titleMedium)),
          ],
        ),
        Divider(
          height: 0,
